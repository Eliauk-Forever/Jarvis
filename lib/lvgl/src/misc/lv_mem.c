...
void lv_mem_init(void)
{
    ...
    work_mem_int = malloc(LV_MEM_SIZE);//[LV_MEM_SIZE / sizeof(MEM_UNIT)];
    if (work_mem_int == NULL)
        LV_LOG_WARN("lv_mem_init malloc failed!\n");
